...
1947: Born officially in the revolutionary days. The Philippine National Red Cross, a member of the International Red Cross
            ...
            of indigent Filipinos in vulnerable sitsuations.
      ...
      <div class="md:flex md:items-center md:justify-between">
        <ul class="flex mb-2 md:order-1 md:ml-4 md:mb-0">
          <li>
            <a href="https://www.facebook.com/profile.php?id=100063824675471" class="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
          ...
          <li class="ml-4">
            <a href="https://www.facebook.com/profile.php?id=100063824675471" class="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
              <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
