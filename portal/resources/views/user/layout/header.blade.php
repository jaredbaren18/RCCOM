...
<html lang="en">
  ...
  <body>
    <header class="sticky top-0 bg-white border-b border-slate-200 z-30 " x-data="{ isOpen: false }">
      ...
      <nav class="container mx-auto px-8 py-3 md:flex md:items-center md:justify-between">
        ...
        <div :class="isOpen ? 'flex' : 'hidden'" class="mt-2 flex-col space-y-4 md:mt-0 md:flex md:flex-row md:items-center md:space-y-0 md:space-x-10">
          <a class="display:none transform font-bold text-gray-800 hover:text-red-700" href="/home">Home</a>


          <a x-data="{ open: true }" class="transform  font-bold text-gray-800 hover:text-red-700 md:hidden" href="membership/#services">Services</a>
    ...
    <div x-data="{ open: false }" @mouseleave="open = false" class="relative hidden md:block">
        ...
        <a
          @mouseover="open = true" 
          class="transform font-bold text-gray-800 hover:text-red-700" href="membership/#services"
        >
          Services
        </a>
        ...
        >
          ...
          <a class="transform font-bold text-gray-800 hover:text-red-700" href="membership/#news">News</a>
          <a class="transform font-bold text-gray-800 hover:text-red-700" href="membership/#contact">Contact</a>
          <a class="transform font-bold text-gray-800 hover:text-red-700" href="membership/#about">About</a>
      ...
      <div id="menu" class="hidden flex flex-col bg-white drop-shadow-md text-center">
        <a class="px-5 py-3 hover:bg-amber-300 border-b border-gray-200" href="/profile">Profile</a>
