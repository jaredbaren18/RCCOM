...
@section('admin-membership-expired')
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Expired Memberships</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <tr>
          ...
          <td><a href="{{url('admin/membership/profile',['mem_id'=>$expired->mem_id])}}"class="btn btn-success">View</a></td>
        </tr>
              @endforeach
            </tbody>
            <tfoot>
