...
@section('admin-membership-declined')
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Declined Memberships</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <tr>
          ...
          <td><a href="{{url('admin/membership/profile',['mem_id'=>$declined->mem_id])}}"class="btn btn-success">View</a></td>
