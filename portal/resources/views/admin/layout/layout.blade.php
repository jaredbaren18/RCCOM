...
@yield('admin-membership-expired')
@yield('admin-membership-pending')
@yield('admin-membership-declined')
@yield('admin-membership-addnew')

{{-- APPOINTMENTS  --}}
@yield('admin-appointment')
@yield('admin-appointment-setter')
