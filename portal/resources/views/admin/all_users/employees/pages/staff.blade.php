...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Employees Staff</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Home</a></li>
            <li class="breadcrumb-item "><a href="{{url('admin/membership')}}">Employees</a></li>
            <li class="breadcrumb-item active"><a href="{{url('admin/membership')}}">Staff</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <tr>{{$no++}}</tr>
          <tr>{{$staff->app_id}}</tr>
          <tr>{{$staff->app_fname}} {{$staff->app_lname}}</tr>
          <tr>{{$staff->app_municipal}}</tr>
          <tr>{{$staff->app_status}}</tr>
